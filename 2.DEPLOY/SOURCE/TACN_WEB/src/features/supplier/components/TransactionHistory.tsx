...
import { TRANSACTION_OBJECT } from 'utils/constants'
import { transactionHistory } from '../SupplierApi'
...
function TransactionHistory({ info }: any) {
  ...
  const getTransactionHistory = async () => {
    try {
      ...
      const res = await transactionHistory({
        object: TRANSACTION_OBJECT.SUPPLIER,
        id: info.id,
        page: page,
        search: '',
      ...
      setTransactionData(convertedArr)
